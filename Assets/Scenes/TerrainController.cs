...
public class TerrainController : MonoBehaviour {
    ...
    [SerializeField]
    private int minObjectsPerTile = 0, maxObjectsPerTile = 6;
    public int MinObjectsPerTile { get { return minObjectsPerTile; } }
    public int MaxObjectsPerTile { get { return maxObjectsPerTile; } }
    [SerializeField]
    private GameObject[] placeableObjects1;
    public GameObject[] PlaceableObjects1 { get { return placeableObjects1; } }
    [SerializeField]
    private Vector3[] placeableObjectSizes1;//the sizes of placeableObjects, in matching order
    public Vector3[] PlaceableObjectSizes1 { get { return placeableObjectSizes1; } }
    [SerializeField]
    private int minObjectsPerTile1 = 5, maxObjectsPerTile1 = 20;
    public int MinObjectsPerTile1 { get { return minObjectsPerTile1; } }
    public int MaxObjectsPerTile1 { get { return maxObjectsPerTile1; } }
    [SerializeField]
	...
	if(playerTransform){
        Vector2 playerTile = TileFromPosition(playerTransform.localPosition + new Vector3(-75f, 0f, 75f));
		...
		if(playerTransform){
            foreach (KeyValuePair<Vector2, GameObject> kv in terrainTiles) {
                if (Vector3.Distance(playerTransform.position + new Vector3(-75f, 0f, 75f), kv.Value.transform.position) > destroyDistance && !kv.Value.activeSelf) {
